 ...
 * @license GPL v3
 */
var DanteNewGH = DanteNewGH || {}, HeaderEncoder = HeaderEncoder || {};
...
HeaderEncoder = function () {
    ...
    return {encodeUrl: url.encode, decodeUrl: url.decode, encodeHtml: html.encode, decodeHtml: html.decode}
}();
var portaluser = {
...
DanteNewGH = function () {
    var settings, defaults = {
        ...
        static_resources_uri: "//img01.bt.co.uk/s/assets/020822",
        activePage: "",
        isPageResponsive: "",
        width: 1154,
    ...
    var methods = {
        addGlobalHeader: function (data) {
            ...
            jqdngh("#bt-navbar").append('<div id="skip"></div><div class="full-navbar"><div class="bt-navbar-menu-container bt-navbar-global-nav" role="navigation" aria-label="Main Navigation"><div class="bt-navbar-inner-section"><div class="bt-navbar-menu bt-navbar-menu-main"></div></div></div></div>');
            jqdngh("#bt-navbar>.full-navbar .bt-navbar-universal-nav").append('');
            ...
            if (settings.displayCountry === "Y") {
                jqdngh("#bt-navbar>.full-navbar .bt-navbar-universal-nav .bt-navbar-inner-section").append('')
            }
            ...
            jqdngh.each(data.global.left, function (key, val) {
                ...
                if (val.style === "sport") {
                    ...
                    if (userStatus === "loggedin") {
                        ...
                        jqdngh("#bt-navbar>.full-navbar  .bt-navbar-global-nav .bt-navbar-inner-section .bt-navbar-menu-main .bt-navbar-left-menu ul.left-nav-ul .bt-navbar-bt-sport-menu").append('<li class="bt-navbar-menu-col-16-percent"> <div><a class="bt-navbar-chevron" href=' + loginlink + ">Log in to BT Sport</a></div> </li>")
                    }
                } else {
                    jqdngh("#bt-navbar>.full-navbar  .bt-navbar-global-nav .bt-navbar-inner-section .bt-navbar-menu-main .bt-navbar-left-menu ul.left-nav-ul").append(menuitem)
                }
