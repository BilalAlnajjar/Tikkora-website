				...
				<div class="row">
                    ...
                    <div class="col-md-12 col-lg-12">
                        <div class="card">
                            ...
                            <div class="btn-list">
                                <a href="add_sub_category.php"><button" class="btn btn-primary"><i class="fe fe-plus mr-2"></i>Add Sub Category</button></a>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example" class="table table-striped table-bordered text-nowrap w-100">
                                        ...
                                        <tr>
                                                ...
                                                <td><a class="btn btn-sm btn-primary" href="add_sub_category.php"><i class="fa fa-edit"></i> Edit</a>
