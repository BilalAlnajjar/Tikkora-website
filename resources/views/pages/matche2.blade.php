...
@if($section_one)
    <div class="section text-white p-20">
...
<div class="flex flex-col items-center">
    ...
    <video id="{{$string_id}}" class="video-js vjs-default-skin"  height="400" controls>
    </video>
</div>
...
<script>
    ...
    $(document).ready(function () {
        addToMeElement.html('<source type="application/x-mpegURL" src="{{$links->first()->url}}">')
        player()
    });

    function getLink(url) {
        addToMeElement.html('<source type="application/x-mpegURL" src="'+url+'">')
        $("#{{$string_id}} source").attr("src", url);
        $("#{{$string_id}}").children().first()[0].load();
        eval(player());
